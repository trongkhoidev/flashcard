...
object DefaultVocabData {
    ...
    fun getDefaultDecks(): List<DeckEntity> {
        return listOf(
            ...
            // Spanish Decks (12th Deck)
            DeckEntity(
                id = "es_basic",
                languageCode = "es",
                title = "Tiếng Tây Ban Nha",
                subtitle = "Từ vựng thông dụng và giao tiếp cơ bản",
                iconEmoji = "💃",
                level = "A1 Inicial",
                colorHex = "#F87171",
                cardCount = 30
    ...
    fun getDefaultFlashCards(): List<FlashCardEntity> {
        return listOf(
            ...
            FlashCardEntity(
                ...
                phonetic = "/ˈo.la/",
                partOfSpeech = "phrase",
                frontExample = "¡Hola! ¿Cómo estás?",
                backMeaning = "Xin chào (Cách chào phổ biến nhất)",
                backExampleTranslation = "Xin chào! Bạn khỏe không?",
                memoryTip = "H câm, phát âm là O-la."
            ),
            FlashCardEntity(
                deckId = "es_basic",
                languageCode = "es",
                ...
                phonetic = "/ˈɡɾa.sjas/",
                partOfSpeech = "phrase",
                frontExample = "Muchas gracias por tu ayuda.",
                backMeaning = "Cảm ơn / Xin cảm ơn",
                backExampleTranslation = "Cảm ơn bạn rất nhiều vì đã giúp đỡ.",
                memoryTip = "Liên tưởng đến 'Grace' trong tiếng Anh."
            )
        )
    }
}
